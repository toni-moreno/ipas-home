  ...
  product_params:
    [
      ...
      },
      {
        ...
        description: 'OpenanewSNMPConnectionforeachmeasurementandsendconcurrentqueriesoverthedevice',
        type: "boolean",
        value: true
      }
    ],
     ...
     [
      {
        ...
        agent_key: "OutDB",
        description: 'InfluxDBserverIDtosenddatato',
        type: "string",
        value: "default"
      },
      {
        ...
        agent_key: "LogLevel",
        description: 'Enableuseselectverbosityofthedevicelog',
        type: "string",
        value: "info"
      },
      {
        ...
        agent_key: "Freq",
        description: 'Frequencyofpollinginseconds(default30secifnotset)',
        type: "string",
        value: 60
      },
      {
        ...
        agent_key: "Timeout",
        description: "TimeoutforeachSNMPquery",
        type: "integer",
        value: 20
      },
      {
        ...
        agent_key: "Retries",
        description: 'SetsthenumberofretriestoattemptwithinTimeout',
        type: "integer",
        value: 5
      },
      {
        ...
        description: 'Numberpofcompletepollsthatagentwillwaitbeforeperformsnmptableindex/filterupdates.ThefinalupdatetimewillbeFreq*FilterUpdate(inseconds)Default60(1helapsedtime)',
        type: "integer",
        value: 60
      },
      {
        ...
        agent_key: "SnmpDebug",
        description: 'Ifthisoptionissetallsnmplowlevelprotocolquerieswithdetailedinfoonthisdevicewillbewrittenonafilewithname"snmpdebug_XXXXXX.log"',
        type: "boolean",
        value: false
      },
      {
        ...
        agent_key: "ExtraTags",
        description: 'DeviceExtraTagkeys',
        type: "string",
        value: null
      }
    ],
