export const ProductSample: ProductFull = 
{
  ...
  "gather": [
    {
      "engine": "snmpcollector",
      "config": [
        {
          "name": "Cisco Catalyst Indexed",
          "models": "XXX,XXX,XXX,XXX",
          "description": "",
          "dir": "gather",
          "config": [
            {
              "source": "template_cisco_catalyst_indexed.tpl.json",
              "dest": null
            }
          ],
          "params": {
            "product_params": [
              ...
              },
              {
                ...
                "type": "array",
                "value": [
                  "Cisco_Template_Catalyst_Indexed_FULL"
                ]
              },
              {
                ...
                "type": "array",
                "value": [
                  "ifType_filter_ifStatus_up_Cisco_Catalyst_Extended"
                ]
              },
              {
              ...
              },
              {
                ...
                "description": "Could be one of these: -id: will send as device tag the configured ID for this measurement -host: will send as device tag data configured in the Host configuration (name or IP)\" type: \"string\"",
                "value": "id"
              },
              {
              ...
              },
              {
                ...
                "description": "Open a new SNMP Connection for each measurement and send concurrent queries over the device",
                "type": "boolean",
                "value": true
              }
            ],
        ...
        {
          "name": "Cisco Catalyst Value",
          "dir": "gather",
          "config": [
            {
              "source": "template_cisco_catalyst_value.tpl.json",
              "dest": null
            }
          ],
          "params": {
            "product_params": [
              ...
              },
              {
                ...
                "type": "array",
                "value": [
                  "Cisco_Template_Catalyst_Value_FULL"
                ]
              },
              {
                "key": "PRODUCT_MEAS_FILTERS",
              ...
              },
              {
                "key": "PRODUCT_DISABLEBULK",
                "agent_key": "DisableBulk",
                "description": "If true the bulk feature would not be used",
                "type": "boolean",
                "value": true
              },
              {
            ...
            "device_params": [
              ...
              },
              {
                "key": "DEVICE_HOST",
                "agent_key": "Host",
                "description": "Device IP to retrieve data from",
                "type": "string",
                "value": null
              },
              {
  ...
  "visual": [
    {
      ...
      "config": [
        {
          "name": "SNMP_CISCO_CATALYST_BY_DEVICE",
          "models": "",
          "description": "",
          "dir": "visual",
          "config": [
            {
              "source": "snmpcollector_switch_catalyst_single.tpl.json",
              "dest": "~/ipas-docker/grafana/provisioning/dashboards/products/snmpcollector_switch_catalyst_single.json"
            }
          ],
          "params": {
            "type": "single",
            "datasource": "snmp_metrics_datasource",
            "measurement_ref": "cisco_catalyst_ifMib_extended",
            "productkey": "device,portName"
          }
        },
        {
          "name": "SNMP_CISCO_CATALYST_BY_GROUP",
          "dir": "visual",
          "config": [
            {
              "source": "snmpcollector_switch_catalyst_group.tpl.json",
              "dest": "~/ipas-docker/grafana/provisioning/dashboards/products/snmpcollector_switch_catalyst_group.json"
            }
          ],
          "params": {
            "type": "group",
            "datasource": "snmp_metrics_datasource",
            "measurement_ref": "cisco_catalyst_ciscoMemoryPool",
            "productkey": "device"
          }
        }
      ]
      ...
      "config": [
        {
          "name": "CPU_ALERT_XXX",
          "dir": "alert",
          "config": "cpu_alert.tpl.json",
          "params": null
        },
        {
          "name": "MEM_ALERT_XXX",
          "dir": "alert",
          "config": "mem_alert.tpl.json",
          "params": null
        }
      ]
    }
